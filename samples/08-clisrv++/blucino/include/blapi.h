...
//==============================================================================
  ...
  typedef enum BL_tag                  // class tag
          {
            ...
            BL_CFGSRV,                 // Config Server
            BL_CFGCLI,                 // Config Client
            BL_HEASRV,                 // Health Server
            BL_HEACLI,                 // Health Client

            BL_GOOCLI,                 // Generic OnOff Client
            BL_GOOSRV,                 // Generic OnOff Server
            BL_GLVCLI,                 // Generic Level Client
            BL_GLVSRV,                 // Generic Level Server
            ...
            BL_BLE,                    // BLE
            BL_NGMN,                   // 3G/4G/5G (next gen mobile networks)
  ...
  typedef void (*BL_notify)(BL_ob *o, int value);
...
//==============================================================================
  ...
  void bl_event(BL_ob *o, int value); // issue an event

//==============================================================================
// state access
//==============================================================================

  void bl_set(BL_ob *o, int value);
