...
static void prov_complete(uint16_t net_idx, uint16_t addr)
{
	...
	BL_obj o = {BL_MESH, BL_PRV, 0, NULL};                               //@@@3.4
	bl_event(&o,1);
}
...
{
	BL_obj o = {BL_BUTTON, BL_SET, sw.sw_num+1, NULL};   // button ID = sw_num+1
...
{
	BL_obj o = {BL_MESH, BL_ATT, 0, NULL};
	bl_event(&o,1);
}
...
//==============================================================================
  ...
  void bl_core_set(BL_obj *o,int value)  // here's how we hook in ...
	{
