...
#define PAIR(tag,op)   (((tag)<<16) | (op))
  ...
  void bl_event(BL_ob *o, int value)
  {
    ...
    switch (pair)                      // dispatch event
    {
      ...
      case PAIR(BL_BUTTON,BL_SET):     // attention state changed
        attention = value;
        bl_log2(2,"@button:set",o->id,value);
        break;

      case PAIR(BL_GOOSRV,BL_LET):
        bl_log2(2,"@goosrv:let",o->id,value);
        break;
...
//==============================================================================
  ...
  void bl_set(BL_ob *o, int value)
  {
    ...
    {
      case BL_GOOCLI:
        bl_log2(2,"@goocli.set", o->id,value);
        bl_core_set(o,value);
        break;

      case BL_LED:
        bl_log2(2,"@led.set", o->id,value);
        bl_core_led(o,value);
        break;

      case BL_BUTTON:
        bl_log2(2,"@button.set", o->id,value);
        bl_core_button(o,value);
        break;
    }
  }
