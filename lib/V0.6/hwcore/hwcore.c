...
//==============================================================================
  ...
  #define LOG                     LOG_CORE
  #define LOGO(lvl,col,o,val)     LOGO_CORE(lvl,col"blhw:",o,val)
...
//==============================================================================
  ...
  void button_workhorse(struct k_work *work)
  {
    ...
    LOGO(1,BL_R,&oo,1);    //
    bl_hw(&oo,1);          // post to public module interface for output
  }
...
//==============================================================================
  ...
  {
    bool val = gpio_pin_get_dt(&button_device[id]);

    BL_ob oo = {_BUTTON,val?PRESS_:RELEASE_,id,NULL};
    LOGO(4,BL_Y,&oo,1);
    bl_hw(&oo,val);        // post [BUTTON:PRESS/RELEASE @id,1] to BL_HW
  }
...
//==============================================================================
  ...
  int bl_hw(BL_ob *o, int val)            // HW core module interface
  {
    ...
    switch (bl_id(o))
    {
      ...
      case BL_ID(_BUTTON,PRESS_):       // [HDL:PRESS @id]
      case BL_ID(_BUTTON,RELEASE_):     // [HDL:RELEASE @id]
